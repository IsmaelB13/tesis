...
Route::get('inicio_sesion', [LoginController::class, 'showLoginForm'])->name('inicio_sesion');

// Ruta para procesar el inicio de sesión
Route::post('inicio_sesion', [LoginController::class, 'inicio_sesion']);
...
route::get('/registrar',[AdminController::class,'registrar']);
